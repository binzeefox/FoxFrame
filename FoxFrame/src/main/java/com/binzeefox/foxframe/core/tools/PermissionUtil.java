...
public class PermissionUtil {
     ...
     */
    public Observable<List<String>> request(final AppCompatActivity activity) {
        ...
        }).compose(RxUtil.<List<String>>setThreadNew());
    }
     ...
     */
    public Observable<List<String>> request(final Fragment fragment) {
    ...
    public static class PermissionFragment extends Fragment {
        private ObservableEmitter<List<String>> emitter; //RxJava的发射器
