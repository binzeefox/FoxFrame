...
public class Downloader {
    ...
    private static final Application mCtx = FoxApplication.get();
    ...
    public Query query(long id) {
        ...
        if (cursor.moveToFirst()) {
            ...
            //下载任务文件名
            fileUriStr = cursor.getString(columnMap.get("fileUri"));
            //文件总大小
            totalBytes = cursor.getInt(columnMap.get("totalBytes"));
            //下载总大小
            currentBytes = cursor.getInt(columnMap.get("currentBytes"));
     ...
     */
    public void setCompleteListener(OnDownloadCompleteListener listener) {
